...
public class RankedEloManagerTest {
  ...
  public void testSingleGame1v1WithSameElo() {
    ...
    // Act
    var result = rankedEloManager.calculateEloChange(
  ...
  public void testMultiGameSet1v1WithSameElo() {
    ...
    // Act 2
    // Player 1 wins 2-1
    result = rankedEloManager.calculateEloChange(
  ...
  public void testSingleGameSet1v1WithDifferentElo() {
    ...
    // Act 2
    result = rankedEloManager.calculateEloChange(List.of(List.of(player2, player1)), GameType.SMASH_ULTIMATE_SINGLES);
