...
public class IndifferentEloManagerTest {

  private static IndifferentEloManager indifferentEloManager;

  @BeforeAll
  public static void setupTest() {
    indifferentEloManager = new IndifferentEloManager();
  }
  ...
  public void testSingleGameSetFreeForAllWithSameElo() {
    ...
    Assertions.assertEquals(result.get(player1), 5);
  ...
  public void testMultiGameSetFreeForAllWithSameElo() {
    ...
    // Verify 2
    Assertions.assertEquals(result.size(), 4);
    Assertions.assertEquals(result.get(player1), 11);
    Assertions.assertEquals(result.get(player2), 0);
    Assertions.assertEquals(result.get(player3), -11);
    Assertions.assertEquals(result.get(player4), 0);
  }
  ...
  public void testSingleGameSetFreeForAllWithDifferentElo() {
    ...
    // since you always tie with someone.
    // In this case Reed wins but he still loses ELO
    Assertions.assertEquals(result.size(), 4);
    Assertions.assertEquals(result.get(player1), -1);
    ...
    // Verify 2
    Assertions.assertEquals(result.size(), 4);
    Assertions.assertEquals(result.get(player1), 3);
    Assertions.assertEquals(result.get(player2), 5);
    Assertions.assertEquals(result.get(player3), -5);
    Assertions.assertEquals(result.get(player4), -3);
  }
  ...
  public void testMultiGameSetFreeForAllWithDifferentElo() {
    ...
    Assertions.assertEquals(result.get(player4), 4);
  }
}
