...
/**
 * Why the fuck am I testing this. It just randomizes the shit.
 * I am just a moth to the flame of "best practice".
 */
public class RandomSeederTest {

  /**
   * Just test inputs and outputs are the same and no crazy BS happens
   */
  @Test
  public void testRandomSeederIsSane() {
    // Setup
    ...
    var player3 = PlayerSet.builder()
      ...
      .build();
    var randomSeeder = new RandomSeeder(new Random(67));

    // Act
    var seededList = randomSeeder.seed(Set.of(player1, player2, player3), GameType.SMASH_ULTIMATE_SINGLES);
